...
impl serde::Serialize for BrandingSettings {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.BrandingSettings", len)?;
...
impl<'de> serde::Deserialize<'de> for BrandingSettings {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.BrandingSettings")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.BrandingSettings", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DomainSettings {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.DomainSettings", len)?;
        if self.login_name_includes_domain {
...
impl<'de> serde::Deserialize<'de> for DomainSettings {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.DomainSettings")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.DomainSettings", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EmbeddedIframeSettings {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.EmbeddedIframeSettings", len)?;
        if self.enabled {
...
impl<'de> serde::Deserialize<'de> for EmbeddedIframeSettings {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.EmbeddedIframeSettings")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.EmbeddedIframeSettings", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetActiveIdentityProvidersRequest {
        ...
        S: serde::Serializer,
    {
        ...
        if self.creation_allowed.is_some() {
            len += 1;
        }
        if self.linking_allowed.is_some() {
            len += 1;
        }
        if self.auto_creation.is_some() {
            len += 1;
        }
        if self.auto_linking.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetActiveIdentityProvidersRequest", len)?;
        if let Some(v) = self.ctx.as_ref() {
            struct_ser.serialize_field("ctx", v)?;
        }
        if let Some(v) = self.creation_allowed.as_ref() {
            struct_ser.serialize_field("creationAllowed", v)?;
        }
        if let Some(v) = self.linking_allowed.as_ref() {
            struct_ser.serialize_field("linkingAllowed", v)?;
        }
        if let Some(v) = self.auto_creation.as_ref() {
            struct_ser.serialize_field("autoCreation", v)?;
        }
        if let Some(v) = self.auto_linking.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetActiveIdentityProvidersRequest {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "creationAllowed" | "creation_allowed" => Ok(GeneratedField::CreationAllowed),
                            "linkingAllowed" | "linking_allowed" => Ok(GeneratedField::LinkingAllowed),
                            "autoCreation" | "auto_creation" => Ok(GeneratedField::AutoCreation),
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetActiveIdentityProvidersRequest")
            }
            ...
            {
                let mut ctx__ = None;
                let mut creation_allowed__ = None;
                let mut linking_allowed__ = None;
                let mut auto_creation__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::CreationAllowed => {
                            if creation_allowed__.is_some() {
                                return Err(serde::de::Error::duplicate_field("creationAllowed"));
                            }
                            creation_allowed__ = map_.next_value()?;
                        }
                        GeneratedField::LinkingAllowed => {
                            if linking_allowed__.is_some() {
                                return Err(serde::de::Error::duplicate_field("linkingAllowed"));
                            }
                            linking_allowed__ = map_.next_value()?;
                        }
                        GeneratedField::AutoCreation => {
                            if auto_creation__.is_some() {
                                return Err(serde::de::Error::duplicate_field("autoCreation"));
                            }
                            auto_creation__ = map_.next_value()?;
                        }
                        GeneratedField::AutoLinking => {
                            if auto_linking__.is_some() {
                                return Err(serde::de::Error::duplicate_field("autoLinking"));
                            }
                            auto_linking__ = map_.next_value()?;
                        }
                    }
                }
                Ok(GetActiveIdentityProvidersRequest {
                    ctx: ctx__,
                    creation_allowed: creation_allowed__,
                    linking_allowed: linking_allowed__,
                    auto_creation: auto_creation__,
                    auto_linking: auto_linking__,
                })
            }
        }
        deserializer.deserialize_struct("zitadel.settings.v2.GetActiveIdentityProvidersRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetActiveIdentityProvidersResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetActiveIdentityProvidersResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for GetActiveIdentityProvidersResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetActiveIdentityProvidersResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetActiveIdentityProvidersResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetBrandingSettingsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetBrandingSettingsRequest", len)?;
        if let Some(v) = self.ctx.as_ref() {
            struct_ser.serialize_field("ctx", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetBrandingSettingsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetBrandingSettingsRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetBrandingSettingsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetBrandingSettingsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetBrandingSettingsResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for GetBrandingSettingsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetBrandingSettingsResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetBrandingSettingsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetDomainSettingsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetDomainSettingsRequest", len)?;
        if let Some(v) = self.ctx.as_ref() {
            struct_ser.serialize_field("ctx", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetDomainSettingsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetDomainSettingsRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetDomainSettingsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetDomainSettingsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetDomainSettingsResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        if let Some(v) = self.settings.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetDomainSettingsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetDomainSettingsResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetDomainSettingsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetGeneralSettingsRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetGeneralSettingsRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetGeneralSettingsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetGeneralSettingsRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetGeneralSettingsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetGeneralSettingsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetGeneralSettingsResponse", len)?;
        if !self.default_org_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetGeneralSettingsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetGeneralSettingsResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetGeneralSettingsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetLegalAndSupportSettingsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetLegalAndSupportSettingsRequest", len)?;
        if let Some(v) = self.ctx.as_ref() {
            struct_ser.serialize_field("ctx", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetLegalAndSupportSettingsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetLegalAndSupportSettingsRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetLegalAndSupportSettingsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetLegalAndSupportSettingsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetLegalAndSupportSettingsResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        if let Some(v) = self.settings.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetLegalAndSupportSettingsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetLegalAndSupportSettingsResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetLegalAndSupportSettingsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetLockoutSettingsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetLockoutSettingsRequest", len)?;
        if let Some(v) = self.ctx.as_ref() {
            struct_ser.serialize_field("ctx", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetLockoutSettingsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetLockoutSettingsRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetLockoutSettingsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetLockoutSettingsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetLockoutSettingsResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        if let Some(v) = self.settings.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetLockoutSettingsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetLockoutSettingsResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetLockoutSettingsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetLoginSettingsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetLoginSettingsRequest", len)?;
        if let Some(v) = self.ctx.as_ref() {
            struct_ser.serialize_field("ctx", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetLoginSettingsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetLoginSettingsRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetLoginSettingsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetLoginSettingsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetLoginSettingsResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        if let Some(v) = self.settings.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetLoginSettingsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetLoginSettingsResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetLoginSettingsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetPasswordComplexitySettingsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetPasswordComplexitySettingsRequest", len)?;
        if let Some(v) = self.ctx.as_ref() {
            struct_ser.serialize_field("ctx", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetPasswordComplexitySettingsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetPasswordComplexitySettingsRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetPasswordComplexitySettingsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetPasswordComplexitySettingsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetPasswordComplexitySettingsResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        if let Some(v) = self.settings.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetPasswordComplexitySettingsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetPasswordComplexitySettingsResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetPasswordComplexitySettingsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetPasswordExpirySettingsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetPasswordExpirySettingsRequest", len)?;
        if let Some(v) = self.ctx.as_ref() {
            struct_ser.serialize_field("ctx", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetPasswordExpirySettingsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetPasswordExpirySettingsRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetPasswordExpirySettingsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetPasswordExpirySettingsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetPasswordExpirySettingsResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        if let Some(v) = self.settings.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetPasswordExpirySettingsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetPasswordExpirySettingsResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetPasswordExpirySettingsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetSecuritySettingsRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetSecuritySettingsRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetSecuritySettingsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetSecuritySettingsRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetSecuritySettingsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetSecuritySettingsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.GetSecuritySettingsResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        if let Some(v) = self.settings.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetSecuritySettingsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.GetSecuritySettingsResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.GetSecuritySettingsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for IdentityProvider {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.IdentityProvider", len)?;
        if !self.id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for IdentityProvider {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.IdentityProvider")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.IdentityProvider", FIELDS, GeneratedVisitor)
    }
}
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                match value {
                    ...
                    "IDENTITY_PROVIDER_TYPE_APPLE" => Ok(IdentityProviderType::Apple),
...
impl serde::Serialize for LegalAndSupportSettings {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.LegalAndSupportSettings", len)?;
        if !self.tos_link.is_empty() {
...
impl<'de> serde::Deserialize<'de> for LegalAndSupportSettings {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.LegalAndSupportSettings")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.LegalAndSupportSettings", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for LockoutSettings {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.LockoutSettings", len)?;
        if self.max_password_attempts != 0 {
...
impl<'de> serde::Deserialize<'de> for LockoutSettings {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.LockoutSettings")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.LockoutSettings", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for LoginSettings {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.LoginSettings", len)?;
        if self.allow_username_password {
...
impl<'de> serde::Deserialize<'de> for LoginSettings {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.LoginSettings")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.LoginSettings", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for PasswordComplexitySettings {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.PasswordComplexitySettings", len)?;
        if self.min_length != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for PasswordComplexitySettings {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.PasswordComplexitySettings")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.PasswordComplexitySettings", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PasswordExpirySettings {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.PasswordExpirySettings", len)?;
        if self.max_age_days != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for PasswordExpirySettings {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.PasswordExpirySettings")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.PasswordExpirySettings", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for SecuritySettings {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.SecuritySettings", len)?;
...
impl<'de> serde::Deserialize<'de> for SecuritySettings {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.SecuritySettings")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.SecuritySettings", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SetSecuritySettingsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.SetSecuritySettingsRequest", len)?;
        if let Some(v) = self.embedded_iframe.as_ref() {
            struct_ser.serialize_field("embeddedIframe", v)?;
        }
        if self.enable_impersonation {
...
impl<'de> serde::Deserialize<'de> for SetSecuritySettingsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.SetSecuritySettingsRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.SetSecuritySettingsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SetSecuritySettingsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.SetSecuritySettingsResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for SetSecuritySettingsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.SetSecuritySettingsResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.SetSecuritySettingsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Theme {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.settings.v2.Theme", len)?;
        if !self.primary_color.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Theme {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.settings.v2.Theme")
            }
        ...
        deserializer.deserialize_struct("zitadel.settings.v2.Theme", FIELDS, GeneratedVisitor)
    }
}
