...
impl serde::Serialize for Details {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.object.v2.Details", len)?;
        if self.sequence != 0 {
...
impl<'de> serde::Deserialize<'de> for Details {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.object.v2.Details")
            }
        ...
        deserializer.deserialize_struct("zitadel.object.v2.Details", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListDetails {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.object.v2.ListDetails", len)?;
        if self.total_result != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for ListDetails {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.object.v2.ListDetails")
            }
        ...
        deserializer.deserialize_struct("zitadel.object.v2.ListDetails", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListQuery {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.object.v2.ListQuery", len)?;
        if self.offset != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for ListQuery {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.object.v2.ListQuery")
            }
        ...
        deserializer.deserialize_struct("zitadel.object.v2.ListQuery", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for Organisation {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.object.v2.Organisation", len)?;
...
impl<'de> serde::Deserialize<'de> for Organisation {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.object.v2.Organisation")
            }
        ...
        deserializer.deserialize_struct("zitadel.object.v2.Organisation", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Organization {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.object.v2.Organization", len)?;
        if let Some(v) = self.org.as_ref() {
            match v {
...
impl<'de> serde::Deserialize<'de> for Organization {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.object.v2.Organization")
            }
        ...
        deserializer.deserialize_struct("zitadel.object.v2.Organization", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RequestContext {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.object.v2.RequestContext", len)?;
...
impl<'de> serde::Deserialize<'de> for RequestContext {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.object.v2.RequestContext")
            }
        ...
        deserializer.deserialize_struct("zitadel.object.v2.RequestContext", FIELDS, GeneratedVisitor)
    }
}
