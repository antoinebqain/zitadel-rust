...
impl serde::Serialize for FeatureFlag {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.FeatureFlag", len)?;
        if self.enabled {
...
impl<'de> serde::Deserialize<'de> for FeatureFlag {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.FeatureFlag")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.FeatureFlag", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetInstanceFeaturesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.GetInstanceFeaturesRequest", len)?;
        if self.inheritance {
...
impl<'de> serde::Deserialize<'de> for GetInstanceFeaturesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.GetInstanceFeaturesRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.GetInstanceFeaturesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetInstanceFeaturesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        if self.oidc_trigger_introspection_projections.is_some() {
            len += 1;
        }
        if self.oidc_legacy_introspection.is_some() {
            len += 1;
        }
        ...
        if self.disable_user_token_event.is_some() {
            len += 1;
        }
        if self.enable_back_channel_logout.is_some() {
            len += 1;
        }
        if self.login_v2.is_some() {
            len += 1;
        }
        if self.permission_check_v2.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.GetInstanceFeaturesResponse", len)?;
        ...
        if let Some(v) = self.oidc_trigger_introspection_projections.as_ref() {
            struct_ser.serialize_field("oidcTriggerIntrospectionProjections", v)?;
        }
        if let Some(v) = self.oidc_legacy_introspection.as_ref() {
            struct_ser.serialize_field("oidcLegacyIntrospection", v)?;
        }
        ...
        if let Some(v) = self.actions.as_ref() {
            struct_ser.serialize_field("actions", v)?;
        }
        if let Some(v) = self.improved_performance.as_ref() {
            struct_ser.serialize_field("improvedPerformance", v)?;
        }
        if let Some(v) = self.web_key.as_ref() {
            struct_ser.serialize_field("webKey", v)?;
        }
        ...
        if let Some(v) = self.disable_user_token_event.as_ref() {
            struct_ser.serialize_field("disableUserTokenEvent", v)?;
        }
        if let Some(v) = self.enable_back_channel_logout.as_ref() {
            struct_ser.serialize_field("enableBackChannelLogout", v)?;
        }
        if let Some(v) = self.login_v2.as_ref() {
            struct_ser.serialize_field("loginV2", v)?;
        }
        if let Some(v) = self.permission_check_v2.as_ref() {
            struct_ser.serialize_field("permissionCheckV2", v)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetInstanceFeaturesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "oidcTriggerIntrospectionProjections" | "oidc_trigger_introspection_projections" => Ok(GeneratedField::OidcTriggerIntrospectionProjections),
                            "oidcLegacyIntrospection" | "oidc_legacy_introspection" => Ok(GeneratedField::OidcLegacyIntrospection),
                            ...
                            "webKey" | "web_key" => Ok(GeneratedField::WebKey),
                            ...
                            "disableUserTokenEvent" | "disable_user_token_event" => Ok(GeneratedField::DisableUserTokenEvent),
                            "enableBackChannelLogout" | "enable_back_channel_logout" => Ok(GeneratedField::EnableBackChannelLogout),
                            "loginV2" | "login_v2" => Ok(GeneratedField::LoginV2),
                            "permissionCheckV2" | "permission_check_v2" => Ok(GeneratedField::PermissionCheckV2),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.GetInstanceFeaturesResponse")
            }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut oidc_trigger_introspection_projections__ = None;
                let mut oidc_legacy_introspection__ = None;
                let mut user_schema__ = None;
                let mut oidc_token_exchange__ = None;
                let mut actions__ = None;
                let mut improved_performance__ = None;
                let mut web_key__ = None;
                let mut debug_oidc_parent_error__ = None;
                let mut oidc_single_v1_session_termination__ = None;
                let mut disable_user_token_event__ = None;
                let mut enable_back_channel_logout__ = None;
                let mut login_v2__ = None;
                let mut permission_check_v2__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::OidcTriggerIntrospectionProjections => {
                            if oidc_trigger_introspection_projections__.is_some() {
                                return Err(serde::de::Error::duplicate_field("oidcTriggerIntrospectionProjections"));
                            }
                            oidc_trigger_introspection_projections__ = map_.next_value()?;
                        }
                        GeneratedField::OidcLegacyIntrospection => {
                            if oidc_legacy_introspection__.is_some() {
                                return Err(serde::de::Error::duplicate_field("oidcLegacyIntrospection"));
                            }
                            oidc_legacy_introspection__ = map_.next_value()?;
                        }
                        ...
                        GeneratedField::WebKey => {
                            if web_key__.is_some() {
                                return Err(serde::de::Error::duplicate_field("webKey"));
                            }
                            web_key__ = map_.next_value()?;
                        }
                        ...
                        GeneratedField::DisableUserTokenEvent => {
                            if disable_user_token_event__.is_some() {
                                return Err(serde::de::Error::duplicate_field("disableUserTokenEvent"));
                            }
                            disable_user_token_event__ = map_.next_value()?;
                        }
                        GeneratedField::EnableBackChannelLogout => {
                            if enable_back_channel_logout__.is_some() {
                                return Err(serde::de::Error::duplicate_field("enableBackChannelLogout"));
                            }
                            enable_back_channel_logout__ = map_.next_value()?;
                        }
                        GeneratedField::LoginV2 => {
                            if login_v2__.is_some() {
                                return Err(serde::de::Error::duplicate_field("loginV2"));
                            }
                            login_v2__ = map_.next_value()?;
                        }
                        GeneratedField::PermissionCheckV2 => {
                            if permission_check_v2__.is_some() {
                                return Err(serde::de::Error::duplicate_field("permissionCheckV2"));
                            }
                            permission_check_v2__ = map_.next_value()?;
                        }
                    }
                }
                Ok(GetInstanceFeaturesResponse {
                    ...
                    oidc_trigger_introspection_projections: oidc_trigger_introspection_projections__,
                    oidc_legacy_introspection: oidc_legacy_introspection__,
                    ...
                    disable_user_token_event: disable_user_token_event__,
                    enable_back_channel_logout: enable_back_channel_logout__,
                    login_v2: login_v2__,
                    permission_check_v2: permission_check_v2__,
                })
            }
        }
        deserializer.deserialize_struct("zitadel.feature.v2.GetInstanceFeaturesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetOrganizationFeaturesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.GetOrganizationFeaturesRequest", len)?;
        if !self.organization_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetOrganizationFeaturesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.GetOrganizationFeaturesRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.GetOrganizationFeaturesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetOrganizationFeaturesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.GetOrganizationFeaturesResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetOrganizationFeaturesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.GetOrganizationFeaturesResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.GetOrganizationFeaturesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetSystemFeaturesRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("zitadel.feature.v2.GetSystemFeaturesRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetSystemFeaturesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.GetSystemFeaturesRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.GetSystemFeaturesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetSystemFeaturesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.GetSystemFeaturesResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        if let Some(v) = self.login_default_org.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetSystemFeaturesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.GetSystemFeaturesResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.GetSystemFeaturesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetUserFeaturesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.GetUserFeaturesRequest", len)?;
        if !self.user_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetUserFeaturesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.GetUserFeaturesRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.GetUserFeaturesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetUserFeaturesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.GetUserFeaturesResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetUserFeaturesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.GetUserFeaturesResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.GetUserFeaturesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ImprovedPerformance {
        ...
        S: serde::Serializer,
    {
        let variant = match self {
            ...
            Self::OrgById => "IMPROVED_PERFORMANCE_ORG_BY_ID",
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                match value {
                    ...
                    "IMPROVED_PERFORMANCE_ORG_BY_ID" => Ok(ImprovedPerformance::OrgById),
...
impl serde::Serialize for ImprovedPerformanceFeatureFlag {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.ImprovedPerformanceFeatureFlag", len)?;
        if !self.execution_paths.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ImprovedPerformanceFeatureFlag {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.ImprovedPerformanceFeatureFlag")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.ImprovedPerformanceFeatureFlag", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for LoginV2 {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.LoginV2", len)?;
        if self.required {
...
impl<'de> serde::Deserialize<'de> for LoginV2 {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.LoginV2")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.LoginV2", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for LoginV2FeatureFlag {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.LoginV2FeatureFlag", len)?;
        if self.required {
            struct_ser.serialize_field("required", &self.required)?;
        }
        if let Some(v) = self.base_uri.as_ref() {
...
impl<'de> serde::Deserialize<'de> for LoginV2FeatureFlag {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = LoginV2FeatureFlag;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.LoginV2FeatureFlag")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<LoginV2FeatureFlag, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut required__ = None;
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.LoginV2FeatureFlag", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ResetInstanceFeaturesRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("zitadel.feature.v2.ResetInstanceFeaturesRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ResetInstanceFeaturesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.ResetInstanceFeaturesRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.ResetInstanceFeaturesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ResetInstanceFeaturesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.ResetInstanceFeaturesResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ResetInstanceFeaturesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.ResetInstanceFeaturesResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.ResetInstanceFeaturesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ResetOrganizationFeaturesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.ResetOrganizationFeaturesRequest", len)?;
        if !self.organization_id.is_empty() {
            struct_ser.serialize_field("organizationId", &self.organization_id)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ResetOrganizationFeaturesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.ResetOrganizationFeaturesRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.ResetOrganizationFeaturesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ResetOrganizationFeaturesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.ResetOrganizationFeaturesResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ResetOrganizationFeaturesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.ResetOrganizationFeaturesResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.ResetOrganizationFeaturesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ResetSystemFeaturesRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("zitadel.feature.v2.ResetSystemFeaturesRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ResetSystemFeaturesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.ResetSystemFeaturesRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.ResetSystemFeaturesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ResetSystemFeaturesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.ResetSystemFeaturesResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ResetSystemFeaturesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.ResetSystemFeaturesResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.ResetSystemFeaturesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ResetUserFeaturesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.ResetUserFeaturesRequest", len)?;
        if !self.user_id.is_empty() {
            struct_ser.serialize_field("userId", &self.user_id)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ResetUserFeaturesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.ResetUserFeaturesRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.ResetUserFeaturesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ResetUserFeaturesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.ResetUserFeaturesResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ResetUserFeaturesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.ResetUserFeaturesResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.ResetUserFeaturesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SetInstanceFeaturesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.SetInstanceFeaturesRequest", len)?;
        if let Some(v) = self.login_default_org.as_ref() {
            struct_ser.serialize_field("loginDefaultOrg", v)?;
        }
        if let Some(v) = self.oidc_trigger_introspection_projections.as_ref() {
...
impl<'de> serde::Deserialize<'de> for SetInstanceFeaturesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.SetInstanceFeaturesRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.SetInstanceFeaturesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SetInstanceFeaturesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.SetInstanceFeaturesResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for SetInstanceFeaturesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.SetInstanceFeaturesResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.SetInstanceFeaturesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SetOrganizationFeaturesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.SetOrganizationFeaturesRequest", len)?;
        if !self.organization_id.is_empty() {
            struct_ser.serialize_field("organizationId", &self.organization_id)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for SetOrganizationFeaturesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.SetOrganizationFeaturesRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.SetOrganizationFeaturesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SetOrganizationFeaturesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.SetOrganizationFeaturesResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for SetOrganizationFeaturesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.SetOrganizationFeaturesResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.SetOrganizationFeaturesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SetSystemFeaturesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.SetSystemFeaturesRequest", len)?;
        if let Some(v) = self.login_default_org.as_ref() {
            struct_ser.serialize_field("loginDefaultOrg", v)?;
        }
        if let Some(v) = self.oidc_trigger_introspection_projections.as_ref() {
...
impl<'de> serde::Deserialize<'de> for SetSystemFeaturesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.SetSystemFeaturesRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.SetSystemFeaturesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SetSystemFeaturesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.SetSystemFeaturesResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for SetSystemFeaturesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.SetSystemFeaturesResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.SetSystemFeaturesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SetUserFeatureRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.SetUserFeatureRequest", len)?;
        if !self.user_id.is_empty() {
            struct_ser.serialize_field("userId", &self.user_id)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for SetUserFeatureRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.SetUserFeatureRequest")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.SetUserFeatureRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SetUserFeaturesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("zitadel.feature.v2.SetUserFeaturesResponse", len)?;
        if let Some(v) = self.details.as_ref() {
            struct_ser.serialize_field("details", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for SetUserFeaturesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct zitadel.feature.v2.SetUserFeaturesResponse")
            }
        ...
        deserializer.deserialize_struct("zitadel.feature.v2.SetUserFeaturesResponse", FIELDS, GeneratedVisitor)
    }
}
